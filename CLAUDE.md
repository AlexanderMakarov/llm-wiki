...
> (fixes, features, tests, PRs) read [`CONTRIBUTING.md`](CONTRIBUTING.md), whose
> short form is loaded automatically from
> [`.claude/rules/contributing.md`](.claude/rules/contributing.md) when you touch
> `llmwiki/`, `tests/`, `scripts/`, or `docs/`. Run `ruff check` and
