...
| Page | Tier | Why |
|---|---|---|
| [`demo/wiki/entities/Claude Code.md`](../../demo/wiki/entities/Claude%20Code.md) | L1 | Flagship model entity — queries about current Claude behaviour always need this |
| [`demo/wiki/entities/Codex CLI.md`](../../demo/wiki/entities/Codex%20CLI.md) | L2 | Reference comparison point, hot but not always loaded |

Project stubs such as `demo/wiki/projects/llm-wiki.md` are generated by `llmwiki build --seed-project-stubs` and are not committed — add `cache_tier` there after seeding.
