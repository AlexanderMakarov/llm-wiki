...
- It does **not** refresh authored demo **sessions**. For release cuts that should look current on the public site, also run `scripts/generate_demo_sessions.py` (and re-synth when `--today` changes) — see [RELEASE_PROCESS.md](RELEASE_PROCESS.md) and #225.
