---
title: "Running llmwiki on an existing Obsidian / Logseq vault (part 1/2)"
slug: running-llmwiki-on-an-existing-obsidian-logseq-vault-01
...
> Part 1 of 2 of **Running llmwiki on an existing Obsidian / Logseq vault**.
