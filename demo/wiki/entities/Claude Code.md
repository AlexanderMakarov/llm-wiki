...
- Serves as a core adapter in `llm-wiki` that auto-detects sessions on every sync without requiring explicit configuration. [[2026-05-10-adapter-registry-refactor]]
...
- Functions as an MCP client capable of consuming MCP-based services. [[2026-08-15-mcp-server-tools]]
