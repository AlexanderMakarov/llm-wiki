...
## [2026-08-10] synthesize | 16 sessions across 2 projects
- Processed: 9 Claude · 3 OpenClaw · 4 docs
- Created: llm-wiki, openclaw-main

## [2026-08-10] synthesize | 28 sessions across 2 projects
- Processed: 19 Claude · 5 OpenClaw · 4 docs
- Created: llm-wiki, openclaw-main

## [2026-08-10] add | Accessibility (WCAG 2.1 AA)

## [2026-08-10] add | Accessibility Audit Summary

## [2026-08-10] add | Writing a New Adapter

## [2026-08-10] add | ChatGPT adapter

## [2026-08-10] add | Claude Code adapter

## [2026-08-10] add | Codex CLI adapter

## [2026-08-10] add | GitHub Copilot adapters

## [2026-08-10] add | Cursor adapter

## [2026-08-10] add | Gemini CLI adapter

## [2026-08-10] add | Obsidian adapter

## [2026-08-10] add | OpenClaw adapter

## [2026-08-10] add | OpenCode / OpenClaw adapter

## [2026-08-10] add | API Guide

## [2026-08-10] add | Architecture

## [2026-08-10] add | Performance Benchmarks

## [2026-08-10] add | Command cheatsheet

## [2026-08-10] add | Competitor Landscape

## [2026-08-10] add | Configuration

## [2026-08-10] add | Configuration Reference

## [2026-08-10] add | Docker deployment

## [2026-08-10] add | Deploying to GitHub Pages

## [2026-08-10] add | Deploying to GitLab Pages

## [2026-08-10] add | Homebrew tap — one-time setup

## [2026-08-10] add | PyPI publishing — one-time setup

## [2026-08-10] add | Deploying to Vercel or Netlify

## [2026-08-10] add | Editorial brand system

## [2026-08-10] add | FAQ

## [2026-08-10] add | Feature Matrix — Every Feature Across the 15 Prior Implementations

## [2026-08-10] add | llmwiki Framework — Building an Agent-Native Dev Tool

## [2026-08-10] add | Getting started

## [2026-08-10] add | Running llmwiki on an existing Obsidian / Logseq vault

## [2026-08-10] add | llmwiki documentation

## [2026-08-10] add | Claude CLI synthesis backend

## [2026-08-10] add | Mode B · Agent

## [2026-08-10] add | Synthesis backends (v1.4.0+)

## [2026-08-10] add | Pick your mode

## [2026-08-10] add | Monthly Project Health Report Template

## [2026-08-10] add | Multi-Agent Setup

## [2026-08-10] add | Obsidian Integration Guide

## [2026-08-10] add | Privacy

## [2026-08-10] add | llmwiki Public Roadmap

## [2026-08-10] add | Cache tiers — load-priority frontmatter

## [2026-08-10] add | CLI reference

## [2026-08-10] add | Entity schema reference (v0.7 · #55)

## [2026-08-10] add | Prompt caching + batch API

## [2026-08-10] add | Reader API contract (v1.2+ preview)

## [2026-08-10] add | Reader-first article shell

## [2026-08-10] add | Slash commands reference

## [2026-08-10] add | State persistence

## [2026-08-10] add | Synthesis cost — what you pay per page, and why

## [2026-08-10] add | UI reference

## [2026-08-10] add | Phase 1.25 — Research Report

## [2026-08-10] add | llmwiki Roadmap — Phase × Layer × Item, prioritised

## [2026-08-10] add | SEO Optimization Guide

## [2026-08-10] add | Star History Tracking

## [2026-08-10] add | Docs style guide

## [2026-08-10] add | Troubleshooting

## [2026-08-10] add | 00 · Quickstart Walkthrough

## [2026-08-10] add | 01 · Installation

## [2026-08-10] add | 02 · First sync

## [2026-08-10] add | 03 · Use with Claude Code

## [2026-08-10] add | 04 · Use with Codex CLI

## [2026-08-10] add | 05 · Query your wiki

## [2026-08-10] add | 06 · Bring your Obsidian / Logseq vault

## [2026-08-10] add | 07 · Example workflows

## [2026-08-10] add | 08 · Synthesize wiki pages with Ollama

## [2026-08-10] add | Setup Guide — Your First LLM Wiki in 15 Minutes

## [2026-08-10] add | Upgrade guide
