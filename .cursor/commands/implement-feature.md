...
Follow `.claude/commands/implement-feature.md` as the source of truth and execute it end to end — every stage, gate, and check in that file applies here unchanged.
