...
[`CONTRIBUTING.md`](../../CONTRIBUTING.md) at the repo root is the **single authoritative source** for how to contribute to llmwiki. Read it before shipping a PR. This file deliberately stays a thin pointer — an earlier version restated the rules and drifted out of sync with them, which is worse than not restating them at all. Add process rules to `CONTRIBUTING.md`, never here.
